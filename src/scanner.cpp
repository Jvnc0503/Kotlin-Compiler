...
bool Scanner::is_id_char(const char c) {
...
static std::unordered_map<std::string, Token::Type> keywords = {
    {"var", Token::VAR}, {"val", Token::VAL}, {"fun", Token::FUN}, {"class", Token::CLASS},
    {"if", Token::IF}, {"else", Token::ELSE}, {"while", Token::WHILE}, {"for", Token::FOR},
    {"break", Token::BREAK}, {"continue", Token::CONTINUE}, {"return", Token::RETURN},
    {"in", Token::IN}, {"this", Token::THIS}, {"Int", Token::INT_TYPE},
    {"Boolean", Token::BOOL_TYPE}, {"Unit", Token::UNIT_TYPE}, {"true", Token::TRUE},
    {"false", Token::FALSE}
};
...
Token *Scanner::nextToken() {
    ...
    switch (c) {
        case '+': type = Token::PLUS;
            break;
        case '-': type = Token::MINUS;
            break;
        case '*': type = Token::MUL;
            break;
        case '/': type = Token::DIV;
            break;
        case '=': type = Token::ASSIGN;
            break;
        case '<': type = Token::LT;
            break;
        case '>': type = Token::GT;
        ...
        case '!': type = Token::NOT;
            break;
        case '(': type = Token::LPAREN;
            break;
        case ')': type = Token::RPAREN;
            break;
        case '{': type = Token::LBRACE;
            break;
        case '}': type = Token::RBRACE;
            break;
        case ':': type = Token::COLON;
            break;
        case ',': type = Token::COMMA;
            break;
        case '.': type = Token::DOT;
            break;
        case ';': type = Token::SEMICOLON;
